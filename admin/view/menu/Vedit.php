        ...
        <div class="panel-body">
            <form role="form" action="index.php?c=procat&a=edit&id=<?php echo $edit->id; ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $edit->title; ?>" name="frm[title]"
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="frm[status]"
                                   id="optionsRadios1" <?php if ($edit->status == '0') echo "checked"; ?> value="0">
                            غیر فعال
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $edit->sort; ?>" name="frm[sort]"
                           id="exampleInputEmail1" placeholder="ترتیب را وارد کنید">
                </div>
