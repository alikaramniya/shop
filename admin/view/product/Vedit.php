<div class="col-lg-12">
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            if (!empty($listSubCat)):
                ?>
                <form role="form" action="index.php?c=product&a=edit&id=<?php echo $edit->id; ?>" method="post"
                      enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1">عنوان</label>
                        <input type="text" class="form-control" name="frm[title]" value="<?php echo $edit->title; ?>"
                               id="exampleInputEmail1" placeholder="عنوان خود را وارد کنید">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="frm[size]"
                                       id="optionsRadios1" <?php if ($edit->size == 1) echo "checked"; ?> value="1">
                                متوسط
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="frm[size]"
                                       id="optionsRadios1" <?php if ($edit->size == 2) echo "checked"; ?> value="2">
                                بزرگ
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="frm[article]" class="ckeditor form-control"
                                  rows="5"><?php echo $edit->article; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFile">توضیحات بلند</label>
                        <textarea name="frm[text]" class="ckeditor form-control"
                                  rows="8"><?php echo $edit->text; ?></textarea>
                    </div>
