                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="public/img/admin/avatar-mini.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="public/img/admin/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="public/img/admin/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="public/img/admin/avatar-mini4.jpg"></span>
                                    <span class="subject">
